...
class TestcheckPreRequisite(unittest.TestCase):
    ...
    def test_pass(self):
        prereqcourse = Course("TEST", CourseCode("TSE1011"), 3, 3, 1, "Lecture", [], [])
        course = Course("TEST COURSE", CourseCode("CSE3055"), 3, 3, 1, "Lecture", [CourseCode("TSE1011")], [])
        adv = Advisor("MCG")
        student = Student("John Doe", "123456789", 3,adv , Transcript(),takenCourses=[prereqcourse])

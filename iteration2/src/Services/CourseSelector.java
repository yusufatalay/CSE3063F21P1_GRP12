...
public class CourseSelector {
    // This method selects random courses for current semester in a given course
    // pool.
    public ArrayList<Course> selectCourses(Student student, ArrayList<Course> allCourses, ArrayList<Course> teCourses,
        ...
        if (studentSemesterNo == 7) {
            int random = (int) (Math.random() * teCourses.size()); // We get a random number to choose randomly from the
                                                                   // list.
